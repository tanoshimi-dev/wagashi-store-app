    ...
    <body>
        ...
        <div class="py-10">
            ...
            <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <form class="space-y-6" action="{{ route('logout-post') }}" method="POST">
                    @csrf
                    <div>
                        <button type="submit" class="flex w-full mt-10 justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">ログアウト</button>
                    </div>
                </form>
            </div>
            </main>
